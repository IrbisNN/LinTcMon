...
class ProtocolVersion(univ.BitString):
  tagSet = univ.BitString.tagSet.tagImplicitly(tag.Tag(tag.tagClassApplication,tag.tagFormatSimple,21))
...
class APtitle(univ.Choice):
  componentType=namedtype.NamedTypes(
    namedtype.NamedType('AP-title-form1',univ.OctetString().subtype(implicitTag=tag.Tag(tag.tagClassContext,tag.tagFormatSimple,0))),
    namedtype.NamedType('AP-title-form2',univ.ObjectIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext,tag.tagFormatSimple,1)))
    )
...
class External(univ.Sequence):
  ...
  componentType=namedtype.NamedTypes(
    namedtype.OptionalNamedType('direct-reference',univ.ObjectIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassUniversal,tag.tagFormatSimple,5))),
    namedtype.OptionalNamedType('indirect-reference',univ.Integer().subtype(implicitTag=tag.Tag(tag.tagClassUniversal,tag.tagFormatSimple,6))),
...
class Associate_source_diagnostic(univ.Choice):
  componentType=namedtype.NamedTypes(
    ...
    namedtype.NamedType('no-reason-given',univ.Integer().subtype(implicitTag=tag.Tag(tag.tagClassContext,tag.tagFormatSimple,2)))
    )
...
class AARE_apdu(univ.Sequence):
  componentType=namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType('responding-AP-title',APtitle().subtype(implicitTag=tag.Tag(tag.tagClassContext,tag.tagFormatSimple, 4))),
    namedtype.OptionalNamedType('responding-AE-qualifier',AEQualifier().subtype(implicitTag=tag.Tag(tag.tagClassContext,tag.tagFormatSimple,5))),
    namedtype.OptionalNamedType('responding-AP-invocation-identifier',APInvocationIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext,tag.tagFormatSimple,6))),
    namedtype.OptionalNamedType('responding-AE-invocation-identifier',AEInvocationIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext,tag.tagFormatSimple,7))),
    namedtype.OptionalNamedType('responder-acse-requirements',ASCE_requirements().subtype(implicitTag=tag.Tag(tag.tagClassContext,tag.tagFormatSimple,8))),
    ...
    namedtype.OptionalNamedType('responding-authentication-value',Authentication_value().subtype(implicitTag=tag.Tag(tag.tagClassContext,tag.tagFormatSimple,10))),
